    ...
    <div class="stats-body">
                ...
                <div class="left-stats">
                  ...
                  <div class="btn-new">
                    <nuxt-link class="ant-btn ant-btn-dashed" to="/admin/article-edit">
                      <font-awesome-icon :icon="['fas', 'plus']" style="margin-right: 4px;" />
                      新的文章
                    </nuxt-link>
                  </div>
                </div>
      ...
      <div class="baidu-stats">
        <a-button v-if="settings.enableStatistics" type="primary" shape="round" href="https://tongji.baidu.com/web/homepage/index" target="_blank">
          <web-font icon="external-link" style="margin-right: 4px;" />
          前往百度统计官网查看访问数据
        </a-button>
      </div>
    </div>
    ...
    clickStats(type) {
      ...
      switch (type) {
        case 'draft':
          ...
          break;
        case 'posts7':
          url = `/admin/article-manage?isDraft=-1&isDeleted=-1&createTime=${moment().subtract(7, 'days').format('YYYY-MM-DD')}&createTime=${moment().format('YYYY-MM-DD')}`;
          break;
        case 'posts30':
          url = `/admin/article-manage?isDraft=-1&isDeleted=-1&createTime=${moment().subtract(30, 'days').format('YYYY-MM-DD')}&createTime=${moment().format('YYYY-MM-DD')}`;
          break;
        case 'postsAll':
          url = '/admin/article-manage?isDraft=-1&isDeleted=-1';
          break;
        ...
        case 'commentsYesterday':
          url = `/admin/comment-manage?createTime=${moment().subtract(1, 'days').format('YYYY-MM-DD')}&createTime=${moment().subtract(1, 'days').format('YYYY-MM-DD')}`;
          break;
        case 'comments7':
          url = `/admin/comment-manage?createTime=${moment().subtract(7, 'days').format('YYYY-MM-DD')}&createTime=${moment().format('YYYY-MM-DD')}`;
          break;
        case 'comments30':
          url = `/admin/comment-manage?createTime=${moment().subtract(30, 'days').format('YYYY-MM-DD')}&createTime=${moment().format('YYYY-MM-DD')}`;
          break;
        case 'guestbookToday':
        ...
        case 'guestbookYesterday':
          url = `/admin/guestbook-manage?createTime=${moment().subtract(1, 'days').format('YYYY-MM-DD')}&createTime=${moment().subtract(1, 'days').format('YYYY-MM-DD')}`;
          break;
        case 'guestbook7':
          url = `/admin/guestbook-manage?createTime=${moment().subtract(7, 'days').format('YYYY-MM-DD')}&createTime=${moment().format('YYYY-MM-DD')}`;
          break;
        case 'guestbook30':
          url = `/admin/guestbook-manage?createTime=${moment().subtract(30, 'days').format('YYYY-MM-DD')}&createTime=${moment().format('YYYY-MM-DD')}`;
          break;
      }
